						...
						<tr>
							...
							<td style="text-align: left;">
								<c:forEach items="${services}" var="service">
									<input type="checkbox" name="selectedServiceId" value="${service.service_id}"/>${service.service_name}<br/>
								</c:forEach>
							</td>
						</tr>
						<tr>
							<td colspan="2"><input type="submit" value="添加新网点"/>&nbsp;<a href="${pageContext.request.contextPath}/admin/departmentManager.form"><input type="button" value="返回"/></a></td>
						</tr>
					</table>
				</form>
			</div>
