				...
				<form action="${pageContext.request.contextPath}/admin/modifyClerk.form" method="post" id="submitClerk">
					...
					<table border='1' cellpadding='0' cellspacing='0' class="prebook_result" style="font-size: 11pt;">
						<tr style="font-weight: bold;">
							<td>业务员名称</td><td>新密码</td><td>所属网点</td>
						</tr>
						<tr>
							<td><input type="text" value="${clerk.clerk_username}" name="clerk_username" id="clerkUsername"/></td>
							<td><input type="password" value="${clerk.clerk_password}" name="clerk_password" id="clerkPassword"/></td>
							<td>
						...
						<tr><td colspan="3"><input type="submit" value="提交"><span style="color:red;" id="error" ></span></td></tr>
					</table><br/><br/>
				</form>
