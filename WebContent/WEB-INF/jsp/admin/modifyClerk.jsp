...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/modifyClerk.js"></script>
    <STYLE type="text/css">
        .edit_td {
            font-size: 10pt;
        }
...
<div class="wrap">
    ...
    <div class="container" align="center">
        ...
        <br/>
        <h3 style="color: green;text-align: center;">修改业务员信息</h3>
        <form action="${pageContext.request.contextPath}/admin/modifyClerk.form" method="post" id="submitClerk">
            <input type="hidden" value="${clerk.clerk_id}" name="clerk_id">
            <table border='1' cellpadding='0' cellspacing='0' class="prebook_result" style="font-size: 11pt;">
                ...
                <tr>
                    <td><input type="text" value="${clerk.clerk_username}" name="clerk_username" id="clerkUsername"/>
                    </td>
                    <td><input type="password" value="${clerk.clerk_password}" name="clerk_password"
                               id="clerkPassword"/></td>
                    <td>
                        <select name="department_id" id="departmentId">
                            <option value="${clerk.department.department_id}">${clerk.department.department_name}</option>
                            <c:forEach items="${departments}" var="department">
                                <c:if test="${department.department_id != clerk.department.department_id}">
                ...
                <tr>
                    <td colspan="3"><input id="submitBut" type="button" value="提交"><span style="color:red;" id="error"></span></td>
                </tr>
            </table>
            <br/><br/>
        </form>
        <p style="text-align: center;font-size: 11pt;"><a
                href="${pageContext.request.contextPath}/admin/clerkManage.form">返回</a></p>
    </div>
    <!--/Container-->
    <div class="foot">
        <p>
