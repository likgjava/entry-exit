		...
		<div class="wrap">
			...
			<div class="container" align="center">
				...
				<table border='1' cellpadding='0' cellspacing='0' class="prebook_result" style="font-size: 11pt;">
					<tr>
						<td colspan="5">
							<a class="newdept" href="javascript:newService();"><img alt="new" src="${pageContext.request.contextPath}/images/plus.png" width="20" height="20">新增业务</a>
						</td>
					</tr>
					<tr style="font-weight: bold;">
						<td>序号</td><td width="325">业务名称</td><td>操作</td>
					</tr>
					<c:forEach items="${services}" var="service" varStatus="i">
						<tr id="serv_${service.service_id}">
							<td>${i.count }</td>
							<td>${service.service_name}</td>
							<td class="edit_td">
								<a href="javascript:updateService(${service.service_id},'${service.service_name}');">编辑</a>&nbsp;
								<a href="${pageContext.request.contextPath}/admin/deleteService.form?serviceId=${service.service_id}" onclick="javascript: return confirm('你确定的要删除   ${service.service_name} 业务记录？')">删除</a></td>
						</tr>
					</c:forEach>
				</table><br/><br/>
